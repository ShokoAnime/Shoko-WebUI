  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'logo-outline': 'var(--logo-outline)',
        'logo-skin': 'var(--logo-skin)',
        'logo-face-shadow': 'var(--logo-face-shadow)',
        'logo-eye-ref1': 'var(--logo-eye-ref1)',
        'logo-eye-ref2': 'var(--logo-eye-ref2)',
        'logo-eye-ref3': 'var(--logo-eye-ref3)',
        'logo-hair-gradient1': 'var(--logo-hair-gradient1)',
        'logo-hair-gradient2': 'var(--logo-hair-gradient2)',
        'logo-hair-gradient3': 'var(--logo-hair-gradient3)',
        'logo-eye-gradient1': 'var(--logo-eye-gradient1)',
        'logo-eye-gradient2': 'var(--logo-eye-gradient2)',
        'logo-eye-gradient3': 'var(--logo-eye-gradient3)',
