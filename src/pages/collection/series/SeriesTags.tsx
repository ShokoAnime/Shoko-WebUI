...
function SeriesTag(props: { item: TagType }) {
  ...
  return (
    <div className="rounded-md bg-panel-background/50 p-8 flex flex-col border-panel-border border gap-y-4 max-w-[29.875rem] cursor-pointer" onClick={() => { setIsOpen(!isOpen); }}>
