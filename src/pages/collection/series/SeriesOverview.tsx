...
const SeriesOverview = () => {
  ...
  return (
    <>
      ...
      {related.length > 0 && (
        <ShokoPanel title="Related Anime" className="w-full" transparent fullHeight={false}>
      ...
      {similar.length > 0 && (
        <ShokoPanel title="Similar Anime" className="w-full" transparent fullHeight={false}>
