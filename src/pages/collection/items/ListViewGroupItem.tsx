...
const ListViewGroupItem = (item: CollectionGroupType, mainSeries?: WebuiGroupExtra) => {
  ...
  return (
    <div key={`group-${item.IDs.ID}`} className="content-center flex flex-col p-8 gap-y-4 rounded bg-background-alt w-[56.875rem] border-background-border border">
      <div className="flex gap-x-4">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex flex-col gap-y-3">
            <div className="gap-y-4 flex flex-nowrap">
              ...
              <div className={cx('gap-x-2 flex align-middle items-center', mainSeries?.EndDate !== null && 'hidden')}>
