    ...
    <div className="p-8 h-full min-w-full relative">
      <div className="flex w-auto space-x-16 rounded bg-background-alt/25 p-8 border-background-border border">
        <div className="grow flex flex-col justify-between">
          ...
          <div className="mt-3 text-4xl font-semibold text-font-main max-w-[93.75rem]">{series.Name}</div>
          ...
          <div className="mt-8 max-w-[93.75rem] text-font-main min-h-[5rem] mb-6">
        ...
        <BackgroundImagePlaceholderDiv imageSrc={`/api/v3/Image/${series.Images.Posters[0].Source}/Poster/${series.Images.Posters[0].ID}`} className="h-[23.875rem] w-[18.5rem] rounded drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] border border-black" />
      </div>
