    ...
    <div className="p-8 h-full min-w-full relative">
      <div className="flex w-auto space-x-16 rounded bg-background-alt/25 p-8 border-background-border border">
        <div className="grow flex flex-col justify-between">
          ...
          <div className="mt-8 line-clamp-3 max-w-[93.75rem] text-font-main min-h-[5rem] bg-gradient-to-t from-transparent to-font-main bg-clip-text text-fill-transparent">
