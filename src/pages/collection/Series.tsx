...
const Series = () => {
  ...
  return (
    <>
      <div className="relative flex w-full gap-x-8">
        <div className="sticky top-0 flex h-full flex-col gap-y-8 rounded-md border border-panel-border bg-panel-background-transparent p-8">
          <SeriesInfo />
        </div>
        <div className="flex w-full max-w-[1487px] flex-col gap-y-8">
