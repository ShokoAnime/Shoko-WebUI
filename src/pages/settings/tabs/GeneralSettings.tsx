...
function GeneralSettings() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-y-6">
        <div className="h-[2.149rem] font-semibold">Theme Options</div>
        <div className="flex flex-col gap-y-1">
          <div className="flex items-center justify-between">
            Theme
            <SelectSmall
      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex justify-between">
          <div className="h-[2.149rem] font-semibold">Notification Options</div>
          <Checkbox
            label="Enable"
      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex justify-between">
          <div className="h-[2.149rem] font-semibold">Log Options</div>
          <Checkbox
            id="enable-logs"
            label="Enable"
