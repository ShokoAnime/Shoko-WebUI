...
const SettingsPage = () => {
  ...
  const handleHiddenSettingChange = () => {
    if (clickCount === 6) {
      ...
      <div className="relative top-0 z-10 flex w-87.5 flex-col gap-y-4 rounded-lg border border-panel-border bg-panel-background-transparent p-6 font-semibold">
        <div className="sticky top-6">
          ...
          <div className="flex flex-col items-center gap-y-2">
            ...
            {configQuery.isFetching && dynamicItems.length === 0 && <span className="text-sm opacity-65">Loading…</span>}
            {!configQuery.isFetching && dynamicItems.length === 0 && (
