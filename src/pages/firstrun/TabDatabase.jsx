...
import {
  Button, Callout, FormGroup, HTMLSelect,
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <FieldGroup id="formSQLSeverHostname" label="Hostname:" data={database} field="sqlserver_databaseserver" onChange={changeSetting} isHidden={!db.isSQLServer} />
        ...
        <Button intent="primary" disabled={isLocked} onClick={testDatabase}>Test</Button>
      </React.Fragment>
    );
  }
}
