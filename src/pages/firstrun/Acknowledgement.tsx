...
class Acknowledgement extends React.Component<Props> {
  handleNext = () => {
    const { setSaved, nextPage } = this.props;
    ...
    return (
      <TransitionDiv className="flex flex-col flex-grow text-justify justify-center">
        ...
        <div className="flex justify-center mt-20">
          <Button onClick={() => this.handleNext()} className="bg-color-highlight-1 font-semibold py-5 px-24" disabled={status.State !== 4}>Continue</Button>
        </div>
      </TransitionDiv>
    );
  }
