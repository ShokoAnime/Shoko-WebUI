  ...
  return (
    <TransitionDiv className="flex flex-col justify-center px-96">
      ...
      <div className="flex flex-col my-9">
        ...
        <Input id="Password" value={user.Password} label="Password" type="password" placeholder="Password" onChange={e => dispatch(setUser({ Password: e.target.value }))} className="mt-9" />
