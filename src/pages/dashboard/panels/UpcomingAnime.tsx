...
const UpcomingAnime = () => {
  ...
  const renderDetails = (item: DashboardEpisodeDetailsType ) => {
    ...
    return (<div key={`file-${item.ID}`} className="mr-5 last:mr-0 shrink-0 w-56 h-[25.5rem] font-exo2 content-center flex flex-col">
      ...
      <div style={{ background: `center / cover no-repeat url('/api/v3/Image/${item.SeriesPoster.Source}/Poster/${item.SeriesPoster.ID}')` }} className="grow rounded drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] border border-black" />
