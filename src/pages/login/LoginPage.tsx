            ...
            {initStatus.State === 1 && (
              <div className="flex flex-col justify-center items-center">
                ...
                <div className="mt-2 text-lg">
                  <span className="font-open-sans font-semibold">Status: </span>{initStatus.StartupMessage ?? 'Unknown'}
                </div>
              </div>
            )}
            {initStatus.State === 2 && (
            ...
            {initStatus.State === 4 && (
              <div className="flex flex-col -mt-32">
                <div className="flex flex-col font-semibold">
                  ...
                  <div className="mt-10 font-open-sans text-justify">
                  ...
                  <div className="mt-6 font-open-sans">
