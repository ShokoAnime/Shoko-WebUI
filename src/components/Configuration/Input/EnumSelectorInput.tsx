...
const EnumSelectorInput = (props: AnySchemaProps): React.JSX.Element => {
  ...
  const options = useMemo(() => {
    ...
    const defaultValue = props.schema.default || (props.schema.default === '' && definitions.some(definition =>
        definition.value === ''))
