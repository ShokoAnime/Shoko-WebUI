...
const CodeBlockInput = (props: AnySchemaProps): React.JSX.Element | null => {
  const { schema } = props;
  ...
  const handleChange: OnChange = (value, _context) => {
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          className={cx(
            'flex w-full overflow-hidden rounded-md border border-panel-border',
            size,
            'bg-panel-background',
          )}
        >
