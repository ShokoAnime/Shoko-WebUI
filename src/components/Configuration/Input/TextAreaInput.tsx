...
const TextAreaInput = (props: AnySchemaProps): React.JSX.Element | null => {
  ...
  return (
    <div>
      <div className={cx('flex flex-col justify-between transition-opacity', isDisabled && 'opacity-65')}>
        ...
        <textarea
          className={cx(
            'w-auto appearance-none rounded-lg border border-panel-border bg-panel-input px-3 py-1 text-sm transition ease-in-out focus:shadow-none focus:ring-2 focus:ring-panel-icon-action focus:outline-none focus:ring-inset',
            size,
          )}
