            ...
            <div className="flex flex-col flex-grow justify-between">
              <div className="flex flex-col">
                <div className="flex">
                  ...
                  <Button onClick={() => this.editUsername()} className="flex mt-1 color-highlight-1">
                ...
                <div className="flex mt-1">
                  ...
                  <Button onClick={() => this.editPassword()} className="flex mt-1 color-highlight-1">
                    <FontAwesomeIcon icon={faEdit} />
                  </Button>
                </div>
                <div className="flex mt-1">
              ...
              <div className="flex justify-end mb-2">
                <Button onClick={() => this.handleClose(true)} className="py-1 px-4 bg-color-highlight-1 font-mulish font-semibold text-sm">Save</Button>
              </div>
            </div>
          </div>
        </div>
