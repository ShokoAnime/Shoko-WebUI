...
const UnrecognizedVideo = (props: Props) => {
  ...
  return (
    <div
      className={cx(
        'flex w-full flex-col gap-y-2 border rounded-lg p-4 leading-5 transition-colors bg-panel-background cursor-pointer focus:outline-none focus:border-panel-text!',
        border,
