...
const SeriesSidePanel = ({ series }: SeriesSidePanelProps) => {
  ...
  return (
    <div className="hidden w-full flex-col gap-y-6 rounded-lg border border-panel-border bg-panel-background-transparent p-6 lg:order-last lg:flex lg:max-w-[35%] 2xl:max-w-[28.125rem]">
