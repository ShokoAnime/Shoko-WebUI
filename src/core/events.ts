...
export default {
  ...
  // COLLECTION PAGE
  COLLECTION_PAGE_LOAD: 'EVANT_COLLECTION_PAGE_LOAD',
  // DASHBOARD
  ...
  EVENT_MAINPAGE_RECENT_SERIES_DETAILS: 'EVENT_MAINPAGE_RECENT_SERIES_DETAILS',
  EVENT_MAINPAGE_RECENT_EPISODE_DETAILS: 'EVENT_MAINPAGE_RECENT_EPISODE_DETAILS',
