...
import {
  apiSession, GLOBAL_ALERT, IMPORT_FOLDER_SERIES, JMM_VERSION, LOGOUT, QUEUE_GLOBAL_ALERT,
  SELECT_IMPORT_FOLDER_SERIES, SET_FETCHING, SHOW_GLOBAL_ALERT, UPDATE_AVAILABLE,
} from '../actions';
...
// import {
//   API_ADD_FOLDER, API_EDIT_FOLDER, SET_FORM_DATA, SET_STATUS,
...
function* runImportFolderRescan(action) {
  ...
  const resultJson = yield call(ApiActions.getImportFolderScan, payload);
...
//   if (resultList.error) {
//     yield put({ type: QUEUE_GLOBAL_ALERT,
...
export default function* rootSaga() {
  yield all([
    ...
    takeEvery(Events.IMPORT_FOLDER_RESCAN, runImportFolderRescan),
